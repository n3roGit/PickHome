...
const OVERPASS_CONFIG: ServiceConfig = {
  minIntervalMs: 2000,
  maxRetries: 2,
  retryBaseDelayMs: 2000,
  retryMaxDelayMs: 8000,
...
const NOISE_CONFIG: ServiceConfig = {
  minIntervalMs: 3000,
  maxRetries: 2,
  retryBaseDelayMs: 2000,
  retryMaxDelayMs: 8000,
...
const FLOOD_CONFIG: ServiceConfig = {
  minIntervalMs: 3000,
  maxRetries: 2,
  retryBaseDelayMs: 2000,
  retryMaxDelayMs: 8000,
...
const RADON_CONFIG: ServiceConfig = {
  minIntervalMs: 3000,
  maxRetries: 2,
  retryBaseDelayMs: 2000,
  retryMaxDelayMs: 8000,
...
const CLIMATE_CONFIG: ServiceConfig = {
  minIntervalMs: 2000,
  maxRetries: 2,
  retryBaseDelayMs: 2000,
  retryMaxDelayMs: 8000,
...
function serviceConfig(service: ExternalService): ServiceConfig {
  ...
  if (service === "radon") return RADON_CONFIG;
  if (service === "climate") return CLIMATE_CONFIG;
